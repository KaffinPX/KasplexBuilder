...
* @returns {bigint | undefined}
*/
export function calculateTransactionFee(network_id: NetworkId | string, tx: ITransaction | Transaction): bigint | undefined;
/**
...
* @returns {bigint | undefined}
*/
export function calculateTransactionMass(network_id: NetworkId | string, tx: ITransaction | Transaction): bigint | undefined;
/**
* @category Wallet SDK
